        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                ...
                <form method="POST" class="form-horizontal" action="https://voguepay.com/pay/">
					...
					<input type="hidden" name="memo" value="Refiner's Seed" />
            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
					<form method="post" action="https://voguepay.com/pay/">
						<div class="form-group"><label class="col-sm-2 control-label">Amount</label>
							<div class="col-sm-10">
								<input type="number" name="total" class="form-control" style="width: 50%;">
							</div>
						</div>

						<div class="form-group"><label class="col-sm-2 control-label">Choose Currency</label>
							<div class="col-sm-10">
								<select name="cur" class="form-control" style="width:50%">
									<option value="NGN">₦ - Nigerian Naira</option>
									<option value="USD">$ - US Dollar</option>
									<option value="EUR">€ - Euro</option>
									<option value="GBP">£ - British Pound</option>
						...
						<input type="hidden" name="success_url" value="success" />
						<input type="hidden" name="fail_url" value="fail" />
						<input type="hidden" name="memo" value="Order from Celestine Ayo" />
						<input type="hidden" name="developer_code" value="5a938e2e22158" />
						<input type="image" src="https://voguepay.com/images/buttons/Donation.png" class="buynowimg" style="width: 15%;" />
				</form>
				</div>
			</div>
		</div>
