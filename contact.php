...
<body>
    <div id="wrapper">
        ...
        if (isset($_POST['submit'])) {
              ...
              $ssql = "INSERT INTO contact (username, fullname, email, phoneno, subject, message) VALUES('$user', '$name','$email', '$phoneNum','$subject', '$message')";
              if($conn->query($ssql)){
                echo "Message Sent";
              }else{
        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <h4>To contact us, fill in the details below</h4>
                </div>
                ...
                <form method="POST" class="form-horizontal">
                    ...
                    <div class="form-group" hidden=""><label class="col-sm-2 control-label">Email</label>
                      <div class="col-sm-10"><input type="text" name="email" class="form-control" readonly value="<?php echo $row['email']; ?>"></div>
                    </div>
                    <div class="form-group" hidden=""><label class="col-sm-2 control-label">Phone Number</label>
                      <div class="col-sm-10"><input type="tel" name="phoneNum" class="form-control" readonly value="<?php echo $row['mobile']; ?>"></div>
                    </div>
                    ...
                    <div class="form-group"><label class="col-sm-2 control-label">Message</label>
                      <div class="col-sm-10">
                        ...
                        <textarea class="form-control"name="message" id="limitedtextarea" cols="50" rows="5" class="form-control"  onKeyDown="limitText(this.form.limitedtextarea,this.form.countdown,500);" onKeyUp="limitText(this.form.limitedtextarea,this.form.countdown,500);" required=""></textarea>
                      </div>
                    </div>
                    <div class="hr-line-dashed"></div>
                    <!-- <div class="form-group"><label class="col-sm-2 control-label">Message</label>
