...
<body>
    <div id="wrapper">
        ...
        <div class="wrapper wrapper-content animated fadeInRight">
            <div class="row">
                <?php
                    $getList = "SELECT * FROM media_youtube2website";
                    ...
                    <div class="ibox float-e-margins">
                        ...
                        <div  class="ibox-content profile-content">
                            <div class="row">
                                ...
                                ?>
                                <div class="col-lg-3">
                                <div class="content-box box-default media-video-bg">
                                <a data-toggle="modal" data-target="#om<?php echo $row['video_link']?>"><img src="admin/images/uploads/indexvideo/<?php echo $row['video_image'] ?>" style="margin:3px;"></a>
                                <h6 class="content-box-title"> <?php
                                $desc = "$row[title]";
                                $strCut = substr($desc,0,25); //text limit set
        ...
        <?php 
            ...
            if($count > 0){
                while($row = $result->fetch_assoc()) {
        ?>
            <div class="modal inmodal" id="om<?php echo $row['video_link'];?>" tabindex="-1"  aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content animated fadeIn">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
                        <h4 class="modal-title"><?php echo $row['title']; ?> <?php echo $rw['lname']; ?></h4>
                    </div>
                    <div class="modal-body">
                        <iframe width="100%" height="280" class="index_video" src="https://www.youtube.com/embed/<?php echo $row['video_link']; ?>" frameborder="0" allowfullscreen style=" margin-top:10px; margin-bottom:10px; margin-left:0px; margin-right:10px;">
                        </iframe>
                    </div>
                </div>
            </div>
